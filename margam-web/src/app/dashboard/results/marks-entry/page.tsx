  ...
  return (
    <div className="space-y-6 font-body">
      ...
      <div className="border-b border-light-gray/60 pb-5">
        <h1 className="text-3xl font-bold tracking-tight text-primary font-heading">Subject-wise Marks Entry</h1>
        <p className="text-steel-gray mt-1 text-sm font-caption">
          Select an exam, enter student marks, view real-time grade calculations, and lock results when finalized.
        </p>
      </div>

      {/* Main Component */}
      <MarksEntryForm initialYears={academicYears} initialClasses={classes} />
    </div>
  )
}
