...
import { getTeacherProfile } from '@/lib/repositories/teacher'
  ...
  return (
    <div className="space-y-6 font-body">
      ...
      <div className="flex flex-col gap-4 border-b border-light-gray/60 pb-5">
        <div>
          <Link
            href={`/dashboard/teachers/${profile.id}`}
          ...
          <h1 className="text-3xl font-bold tracking-tight text-primary font-heading">Edit Teacher Profile</h1>
          <p className="text-steel-gray mt-1 text-sm font-caption">
            Modify teacher credentials, specialization, qualification, contact, and address details.
          </p>
        </div>
      </div>
